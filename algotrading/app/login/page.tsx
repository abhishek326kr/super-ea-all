    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-12 relative">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-neon-green/10 rounded-full blur-[150px] animate-pulse" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                type="checkbox"
                                id="remember"
                                className="w-4 h-4 rounded border-white/20 bg-white/5 text-neon-green focus:ring-neon-green/30 accent-neon-green"
                            />
